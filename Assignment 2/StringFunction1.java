...
public final class StringFunction1 extends Function1 {
     ...
     * STRLEN
     */
    public static final int STRLEN = QUOTE_IDENT + 1;

    /**
     * STRREVERSE
     */
    public static final int STRREVERSE = STRLEN + 1;

    private static final String[] NAMES = { //
            "UPPER", "LOWER", "ASCII", "CHAR", "STRINGENCODE", "STRINGDECODE", "STRINGTOUTF8", "UTF8TOSTRING",
            "HEXTORAW", "RAWTOHEX", "SPACE", "QUOTE_IDENT" , "STRLEN", "STRREVERSE"//
    };
    ...
    public Value getValue(SessionLocal session) {
        ...
        case QUOTE_IDENT:
            ...
            break;
        case STRLEN:
            v = ValueInteger.get(v.getString().length());
            break;
        case STRREVERSE:
            StringBuilder input = new StringBuilder(v.getString());
            input.reverse();
            v = ValueVarchar.get(input.toString());
            break;
        default:
